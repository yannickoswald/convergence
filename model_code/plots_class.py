...
class Plots():
    ...
    def plot_country_decile_emissions(self, country_identifier, ax=None):
        """
        Description:
        ...
        ax.set_ylabel('Emissions (Metric Tons $CO_2$)', fontsize=11)
        ax.margins(0)
        ax.set_ylim(bottom=0)
        
        # Only draw the legend if it's a standalone plot
        if show_plot:
